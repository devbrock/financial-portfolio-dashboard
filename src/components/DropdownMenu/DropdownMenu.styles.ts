...
export const dropdownMenuContentClassName =
  [
    "min-w-48 rounded-xl border border-(--ui-border) bg-(--ui-bg) shadow-md shadow-black/10 p-1",
...
export const dropdownMenuItemClassName =
  "w-full text-left px-3 py-2 text-sm rounded-lg hover:bg-(--ui-surface) focus:bg-(--ui-surface) outline-none";
